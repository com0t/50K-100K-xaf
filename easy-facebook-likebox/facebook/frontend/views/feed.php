...
if ( isset( $efbl_posts ) && !empty($efbl_posts) ) {
    ...
    if ( $show_like_box ) {
        ...
        echo  do_shortcode( '[efb_likebox fanpage_url="' . $fanpage_id . '" box_width="" box_height="500" colorscheme="light" locale="en_US" responsive="1" show_faces="0" show_header="0" show_stream="0" show_border="0" ]' ) ;
        ?></div>
			<?php 
    }
